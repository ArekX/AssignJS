(function(core) {
    ...
    function ComponentModule(containerManager, makeManager, parser, makeEventEmitter, assignments) {
        ...
        function makeComponent(element, config) {
            ...
            container.events.register('afterLink', initializeComponent);
            container.events.register('beforeUnlink', unsetComponent);

            if (parentContainer) {
                parentContainer.events.register('beforeUnlink', function() {
                    container.unlink();
                });
            }
